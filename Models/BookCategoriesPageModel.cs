...
namespace Olaeriu_Teodora_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Olaeriu_Teodora_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Olaeriu_Teodora_Lab2Context context,
